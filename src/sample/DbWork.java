...
//            String query = "SELECT login, pasword FROM user";
            ...
            while (resultSet.next()){
                ...
                password = resultSet.getString("pasword");
            }
    ...
    public boolean saveUser(User user){
        ...
        try {
            Statement statement = connection.createStatement();
            String query = "insert into user(login,pasword) values(?,?)";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setString(1,user.getLogin());
  ...
  public Connection getConnection(){
      ...
      try {
          ...
          connection = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\iskan\\mydb.db");
